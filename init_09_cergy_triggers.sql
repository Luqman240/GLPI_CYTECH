-- init_09_cergy_triggers.sql
-- Création des triggers sur le site de Cergy
...
GRANT EXECUTE ON c##glpi_central.current_user_client_id TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.current_user_id TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.current_user_site_id TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.current_user_role TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.current_user_email TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.check_ticket_permissions TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.check_ticket_update_permissions TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.check_computer_permission TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.check_printer_permission TO c##glpi_cergy;
GRANT EXECUTE ON c##glpi_central.check_ticket_site_permission TO c##glpi_cergy;

-- Grant access to the views
GRANT SELECT ON c##glpi_central.cergy_users TO c##glpi_cergy;
GRANT SELECT ON c##glpi_central.pau_users TO c##glpi_cergy;
GRANT SELECT ON c##glpi_central.global_users TO c##glpi_cergy;
