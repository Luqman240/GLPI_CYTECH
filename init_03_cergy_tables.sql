-- init_03_cergy_tables.sql
-- Création des tables dans le schéma Cergy

CONNECT c##glpi_cergy/glpi_cergy

-- Tables spécifiques au site Cergy
...
-- Créer des synonymes pour accéder aux tables centrales depuis Cergy
...
-- Séquences pour Cergy (IDs impairs)
CREATE SEQUENCE c##glpi_cergy.seq_user_id START WITH 1 INCREMENT BY 2;
CREATE SEQUENCE c##glpi_cergy.seq_computer_item_id START WITH 1 INCREMENT BY 2;
CREATE SEQUENCE c##glpi_cergy.seq_printer_item_id START WITH 1 INCREMENT BY 2;
CREATE SEQUENCE c##glpi_cergy.seq_ticket_id START WITH 1 INCREMENT BY 2;
CREATE SEQUENCE c##glpi_cergy.seq_ticket_item_id START WITH 1 INCREMENT BY 2;
CREATE SEQUENCE c##glpi_cergy.seq_ticket_issue_id START WITH 1 INCREMENT BY 2;
...
-- Création des index pour le site de Cergy
